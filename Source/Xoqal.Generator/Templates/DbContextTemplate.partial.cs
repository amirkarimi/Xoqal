...
namespace Xoqal.Generator.Templates
{
    ...
    public partial class DbContextTemplate
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DbContextTemplate" /> class.
        /// </summary>
        /// <param name="options">The options.</param>
        /// <param name="codeConventionService">The code convention service.</param>
        public DbContextTemplate(GeneratorOptions options, CodeConventionService codeConventionService)
        {
