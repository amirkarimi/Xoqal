#region License
// ServiceClassTemplate.partial.cs
// 
...
namespace Xoqal.Generator.Templates
{
    ...
    public partial class ServiceClassTemplate
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceClassTemplate" /> class.
        /// </summary>
        /// <param name="options">The options.</param>
        /// <param name="entityInfo">The entity info.</param>
        /// <param name="codeConventionService">The code convention service.</param>
        public ServiceClassTemplate(GeneratorOptions options, EntityInfo entityInfo, CodeConventionService codeConventionService)
        {
