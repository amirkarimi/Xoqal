...
namespace Xoqal.Security.EntityFramework
{
    ...
    /// Role repository.
    /// </summary>
    public class DbContextRoleRepository<T> : DbContextRepository<T>, IRoleRepository<T>
        where T : class, IRole
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DbContextRoleRepository{T}" /> class.
        /// </summary>
